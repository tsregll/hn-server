 ...
 * @date 2021-07-28
 */
public class BusinessDevelopmentConstructionPreparationTimeVo
{
...
//    开发协议签订_计划完成日期
@Excel(name = "开发协议签订_计划完成日期")
    private String signingPlaningTime;
//    开发协议签订_完成日期
@Excel(name = "开发协议签订_实际完成日期")
    private String signingTime;
    //    备案_计划完成日期
    @Excel(name = "备案_计划完成日期")
    private String recordPlaningTime;
    //    备案_完成日期
    @Excel(name = "备案_实际完成日期")
    private String recordTime;
    //    可研定稿_计划完成日期
    @Excel(name = "可研定稿_计划完成日期")
    private String draftPlaningTime;
    //    可研定稿_完成日期
    @Excel(name = "可研定稿_实际完成日期")
    private String draftTime;
    //    接入、环评手续_计划完成日期
    @Excel(name = "接入、环评手续_计划完成日期")
    private String formalityPlaningTime;
    //    开发协议签订_完成日期
    @Excel(name = "接入、环评手续_实际完成日期")
    private String formalityTime;
    //    开发协议签订_计划完成日期
    @Excel(name = "投资决策_计划完成日期")
    private String decisionPlaningTime;
    //    开发协议签订_完成日期
    @Excel(name = "投资决策_实际完成日期")
    private String decisionTime;
    //    设备招标_计划完成日期
    @Excel(name = "设备招标_计划完成日期")
    private String equipmentPlaningTime;
    //    设备招标_完成日期
    @Excel(name = "设备招标_实际完成日期")
    private String equipmentTime;
    //    主体施工招标_计划完成日期
    @Excel(name = "主体施工招标_计划完成日期")
    private String constructionPlaningTime;
    //    主体施工招标_完成日期
    @Excel(name = "主体施工招标_实际完成日期")
    private String constructionTime;
    //    开工_计划完成日期
    @Excel(name = "开工_计划完成日期")
    private String constructingPlaningTime;
    //    开工_完成日期
    @Excel(name = "开工_实际完成日期")
