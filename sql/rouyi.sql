/*
 ...
 Source Host           : 120.27.241.99:3306
 Source Schema         : rouyi
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RuoyiScheduler', 'iZbp1d6s96frrqei7y0lymZ1612170381240', 1612176255469, 15000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1612170390000, -1, 5, 'PAUSED', 'CRON', 1612170381000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1612170390000, -1, 5, 'PAUSED', 'CRON', 1612170381000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1612170400000, -1, 5, 'PAUSED', 'CRON', 1612170381000, 0, NULL, 2, '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `gen_table` VALUES (1, 'sys_dating_user', 'Dating用户表', 'SysDatingUser', 'crud', 'com.ruoyi.dating.user', 'dating', 'user', 'Dating', 'ruoyi', '0', '/', '{\"parentMenuId\":4}', 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48', NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='代码生成业务表字段';

-- ----------------------------
-- Records of gen_table_column
-- ----------------------------
BEGIN;
INSERT INTO `gen_table_column` VALUES (1, '1', 'id', '主键', 'int(11)', 'Long', 'id', '1', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
INSERT INTO `gen_table_column` VALUES (2, '1', 'phone', '手机号\n手机手机号\n\n', 'varchar(11)', 'String', 'phone', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
INSERT INTO `gen_table_column` VALUES (3, '1', 'password', '密码\n', 'varchar(16)', 'String', 'password', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
INSERT INTO `gen_table_column` VALUES (4, '1', 'gender', '性别（1 男 2 女）\n', 'int(11)', 'Long', 'gender', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 4, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
INSERT INTO `gen_table_column` VALUES (5, '1', 'source', '渠道\n', 'varchar(50)', 'String', 'source', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 5, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
INSERT INTO `gen_table_column` VALUES (6, '1', 'avatar', '头像\n', 'varchar(200)', 'String', 'avatar', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 6, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
INSERT INTO `gen_table_column` VALUES (7, '1', 'nickname', '昵称\n', 'varchar(50)', 'String', 'nickname', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '', 7, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
INSERT INTO `gen_table_column` VALUES (8, '1', 'city', '城市ID\n', 'int(11)', 'Long', 'city', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 8, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
INSERT INTO `gen_table_column` VALUES (9, '1', 'birthday', '生日\n', 'varchar(20)', 'String', 'birthday', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 9, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
INSERT INTO `gen_table_column` VALUES (10, '1', 'profession', '职业', 'varchar(20)', 'String', 'profession', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 10, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
INSERT INTO `gen_table_column` VALUES (11, '1', 'income', '收入', 'varchar(20)', 'String', 'income', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 11, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
INSERT INTO `gen_table_column` VALUES (12, '1', 'invite_code', '邀请码（非必填）\n', 'varchar(20)', 'String', 'inviteCode', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 12, 'admin', '2020-10-21 20:29:59', '', '2020-10-21 20:31:48');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='参数配置表';
...
-- ----------------------------
-- Table structure for sys_dating_user
-- ----------------------------
DROP TABLE IF EXISTS `sys_dating_user`;
CREATE TABLE `sys_dating_user` (
  `id` int(11) NOT NULL COMMENT '主键',
  `phone` varchar(11) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '手机号\n手机手机号\n\n',
  `password` varchar(16) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '密码\n',
  `gender` int(11) DEFAULT NULL COMMENT '性别（1 男 2 女）\n',
  `source` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '渠道\n',
  ...
  `profession` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '职业',
  `income` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '收入',
  `invite_code` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '邀请码（非必填）\n',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='Dating用户表';
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=117 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='系统访问记录';

-- ----------------------------
-- Records of sys_logininfor
-- ----------------------------
BEGIN;
INSERT INTO `sys_logininfor` VALUES (100, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2020-10-19 23:50:53');
INSERT INTO `sys_logininfor` VALUES (101, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2020-10-19 23:51:18');
INSERT INTO `sys_logininfor` VALUES (102, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2020-10-20 00:12:15');
INSERT INTO `sys_logininfor` VALUES (103, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2020-10-21 20:09:16');
INSERT INTO `sys_logininfor` VALUES (104, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2020-10-21 20:11:06');
INSERT INTO `sys_logininfor` VALUES (105, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2020-10-21 20:11:16');
INSERT INTO `sys_logininfor` VALUES (106, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2020-10-21 20:29:47');
INSERT INTO `sys_logininfor` VALUES (107, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2020-10-29 20:20:50');
INSERT INTO `sys_logininfor` VALUES (108, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2021-01-04 11:15:47');
INSERT INTO `sys_logininfor` VALUES (109, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '1', '用户不存在/密码错误', '2021-01-19 14:32:41');
INSERT INTO `sys_logininfor` VALUES (110, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2021-01-19 14:34:27');
INSERT INTO `sys_logininfor` VALUES (111, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '1', '用户不存在/密码错误', '2021-01-19 14:34:43');
INSERT INTO `sys_logininfor` VALUES (112, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '1', '验证码错误', '2021-01-19 14:34:46');
INSERT INTO `sys_logininfor` VALUES (113, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2021-01-19 14:34:52');
INSERT INTO `sys_logininfor` VALUES (114, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '1', '用户不存在/密码错误', '2021-01-19 15:06:36');
INSERT INTO `sys_logininfor` VALUES (115, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2021-01-19 15:07:08');
INSERT INTO `sys_logininfor` VALUES (116, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2021-02-01 17:06:47');
COMMIT;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1061 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='菜单权限表';
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='操作日志记录';

-- ----------------------------
-- Records of sys_oper_log
-- ----------------------------
BEGIN;
INSERT INTO `sys_oper_log` VALUES (100, '在线用户', 7, 'com.ruoyi.web.controller.monitor.SysUserOnlineController.forceLogout()', 'DELETE', 1, NULL, NULL, '/monitor/online/686634d8-f63c-4f4c-86d4-bfa907ffc0d9', '127.0.0.1', '内网IP', '{tokenId=686634d8-f63c-4f4c-86d4-bfa907ffc0d9}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-10-19 23:51:10');
INSERT INTO `sys_oper_log` VALUES (101, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'sys_dating_user', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-10-21 20:29:59');
INSERT INTO `sys_oper_log` VALUES (102, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{\"functionAuthor\":\"ruoyi\",\"columns\":[{\"usableColumn\":false,\"columnId\":1,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"id\",\"htmlType\":\"input\",\"edit\":false,\"query\":false,\"columnComment\":\"主键\",\"sort\":1,\"list\":false,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"admin\",\"isPk\":\"1\",\"createTime\":1603283399000,\"tableId\":1,\"pk\":true,\"columnName\":\"id\"},{\"usableColumn\":false,\"columnId\":2,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"phone\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"手机号\\n手机手机号\\n\\n\",\"isQuery\":\"1\",\"sort\":2,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(11)\",\"createBy\":\"admin\",\"isPk\":\"0\",\"createTime\":1603283399000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":false,\"columnName\":\"phone\"},{\"usableColumn\":false,\"columnId\":3,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"password\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"密码\\n\",\"isQuery\":\"1\",\"sort\":3,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(16)\",\"createBy\":\"admin\",\"isPk\":\"0\",\"createTime\":1603283399000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":false,\"columnName\":\"password\"},{\"usableColumn\":false,\"columnId\":4,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"gender\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"性别（1 男 2 女）\\n\",\"isQuery\":\"1\",\"sort\":4,\"list\":true,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"admin\",\"isPk\":\"0\",\"createTime\":1603283399000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":false,\"columnName\":\"gender\"},{\"usableColumn\":false,\"columnI', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-10-21 20:30:07');
INSERT INTO `sys_oper_log` VALUES (103, '代码生成', 8, 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/tool/gen/batchGenCode', '127.0.0.1', '内网IP', '{}', 'null', 0, NULL, '2020-10-21 20:30:14');
INSERT INTO `sys_oper_log` VALUES (104, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{\"functionAuthor\":\"ruoyi\",\"columns\":[{\"usableColumn\":false,\"columnId\":1,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"id\",\"htmlType\":\"input\",\"edit\":false,\"query\":false,\"columnComment\":\"主键\",\"updateTime\":1603283407000,\"sort\":1,\"list\":false,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"admin\",\"isPk\":\"1\",\"createTime\":1603283399000,\"tableId\":1,\"pk\":true,\"columnName\":\"id\"},{\"usableColumn\":false,\"columnId\":2,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"phone\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"手机号\\n手机手机号\\n\\n\",\"isQuery\":\"1\",\"updateTime\":1603283407000,\"sort\":2,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(11)\",\"createBy\":\"admin\",\"isPk\":\"0\",\"createTime\":1603283399000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":false,\"columnName\":\"phone\"},{\"usableColumn\":false,\"columnId\":3,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"password\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"密码\\n\",\"isQuery\":\"1\",\"updateTime\":1603283407000,\"sort\":3,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(16)\",\"createBy\":\"admin\",\"isPk\":\"0\",\"createTime\":1603283399000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":false,\"columnName\":\"password\"},{\"usableColumn\":false,\"columnId\":4,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"gender\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"性别（1 男 2 女）\\n\",\"isQuery\":\"1\",\"updateTime\":1603283407000,\"sort\":4,\"list\":true,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"admin\",\"isPk\":\"0\",\"createT', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-10-21 20:31:48');
INSERT INTO `sys_oper_log` VALUES (105, '代码生成', 8, 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/tool/gen/batchGenCode', '127.0.0.1', '内网IP', '{}', 'null', 0, NULL, '2020-10-21 20:31:52');
INSERT INTO `sys_oper_log` VALUES (106, '用户管理', 2, 'com.ruoyi.web.controller.system.SysUserController.resetPwd()', 'PUT', 1, 'admin', NULL, '/system/user/resetPwd', '127.0.0.1', '内网IP', '{\"admin\":true,\"password\":\"123456\",\"params\":{},\"userId\":1}', 'null', 1, '不允许操作超级管理员用户', '2021-01-19 15:08:02');
COMMIT;
...
CREATE TABLE `sys_user` (
  ...
  `del_flag` char(1) COLLATE utf8mb4_bin DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `login_ip` varchar(50) COLLATE utf8mb4_bin DEFAULT '' COMMENT '最后登录IP',
